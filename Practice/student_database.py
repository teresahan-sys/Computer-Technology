...
while True:
    ...
    if user_input == "1":
        ...
        if another_input == "1":
            ...
            if max(empty_list) == empty_list[0]:
                print("Alice was top student for subject 1!")
                break
            elif max(empty_list) == empty_list[1]:
                print("Bob was top student for subject 1!")
                break
            elif max(empty_list) == empty_list[2]:
                print("Sophia was top student for subject 1!")
                break
            ...
            for student in data:
                ...
                empty_list.append(first_mark)
            if max(empty_list) == empty_list[0]:
                print("Alice was top student for subject 2!")
                break
            elif max(empty_list) == empty_list[1]:
                print("Bob was top student for subject 2!")
                break
            elif max(empty_list) == empty_list[2]:
                print("Sophia was top student for subject 2!")
                break
            ...
            for student in data:
                ...
                empty_list.append(first_mark)
            if max(empty_list) == empty_list[0]:
                print("Alice was top student for subject 3!")
                break
            elif max(empty_list) == empty_list[1]:
                print("Bob was top student for subject 3!")
                break
            elif max(empty_list) == empty_list[2]:
                print("Sophia was top student for subject 3!")
                break
        else:
